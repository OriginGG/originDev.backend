...
alter table origin.blogs disable row level security;

revoke select, insert, update, delete on table origin.blogs from origin_anonymous, origin_user, origin_admin;

grant select on table origin.blogs to origin_anonymous;
grant select, insert, update, delete on table origin.blogs to origin_user, origin_admin;
